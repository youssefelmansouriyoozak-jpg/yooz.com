...
const HeroSection: React.FC = () => {
  ...
  if (!mounted) {
    return (
      <div
        className="h-[280px] md:h-[56.25vw] bg-gray-100 animate-pulse"
        aria-hidden="true"
      />
    );
  }
  ...
  return (
    ...
    >
      {/* HERO */}
      <div className="relative h-[280px] md:h-[56.25vw] w-full min-h-[500px]">
        ...
        {/* OVERLAY */}
        <div
          className="absolute inset-0 bg-gradient-to-r from-white/90 via-white/40 to-transparent md:from-white/80 md:via-white/20 md:to-transparent"
          aria-hidden="true"
        />
          ...
          <div className="container h-full flex flex-col justify-center max-w-[1200px] mx-auto px-4 md:px-8">
            <div className="max-w-[650px]">
              ...
              <h1 className="editorial-title text-[#1D1D1B] text-[32px] md:text-[72px] lg:text-[84px] leading-[0.9] mb-8 font-black uppercase tracking-tighter animate-in fade-in slide-in-from-left duration-700">
                ...
                <span className="italic font-light lowercase opacity-80">
                  à chaque pas
                </span>
              </h1>
